...
const Section = ({ title, image, text }: SectionProps) => {
  return (
    <div className="my-24 mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
      <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
        <div className="lg:pr-4">
          ...
          <div className="max-w-xl mt-12 text-base/7 text-gray-700 lg:max-w-lg">
            <p>{text}</p>
          </div>
        </div>
